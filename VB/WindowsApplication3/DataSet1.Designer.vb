...
Namespace WindowsApplication3
    ...
    Partial Public Class DataSet1
        ...
        Partial Public Class CustomerInfoDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Function AddCustomerInfoRow(ByVal Column1 As Integer, ByVal Column2 As Integer, ByVal Column3 As Integer, ByVal Column4 As Integer, ByVal Column5 As Integer, ByVal Column6 As String) As CustomerInfoRow
                Dim rowCustomerInfoRow As CustomerInfoRow = (CType(Me.NewRow(), CustomerInfoRow))
                Dim columnValuesArray() As Object = {Column1, Column2, Column3, Column4, Column5, Column6}
        ...
        Partial Public Class CustomerInfoRow
            ...
            Public Property Column1() As Integer
                Get
                    Try
                        Return (CInt(Math.Truncate(Me(Me.tableCustomerInfo.Column1Column))))
            ...
            Public Property Column2() As Integer
                Get
                    Try
                        Return (CInt(Math.Truncate(Me(Me.tableCustomerInfo.Column2Column))))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property Column3() As Integer
                Get
                    Try
                        Return (CInt(Math.Truncate(Me(Me.tableCustomerInfo.Column3Column))))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property Column4() As Integer
                Get
                    Try
                        Return (CInt(Math.Truncate(Me(Me.tableCustomerInfo.Column4Column))))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property Column5() As Integer
                Get
                    Try
                        Return (CInt(Math.Truncate(Me(Me.tableCustomerInfo.Column5Column))))
                    Catch e As Global.System.InvalidCastException
